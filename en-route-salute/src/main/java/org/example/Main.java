...
// of inefficiency and come up with ways to remove them are generously rewarded.
...
// (Commander Lambda's salute is a bit, er, involved). You think that by removing the
// salute requirement, you could save several collective hours of employee time per day.
...
//
// Each hallway string will contain three different types of characters: '>', an employee
// walking to the right; '<', an employee walking to the left; and '-', an empty space.
// Every employee walks at the same speed either to right or to the left, according to their
// direction. Whenever two employees cross, each of them salutes the other. They then
// continue walking until they reach the end, finally leaving the hallway.
...
// hallway and returns the number of times the employees will salute. s will contain at
